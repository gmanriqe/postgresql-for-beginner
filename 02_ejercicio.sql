...
-- TODOS LOS REGISTROS CUYO PRIMER NOMBRE SEA Jim (engañosa)
SELECT *
FROM USERS_
WHERE name 
LIKE 'Jim %'
...
SELECT MAX(id)
FROM USERS_ -- veo el registro maximo (ultimo registro)

DELETE USERS_
WHERE id= (
	SELECT MAX(id)
	FROM USERS_
) -- entre el parentesis seria un subquery, quien siempre estara eliminando el ultimo y no tengo la necesidad de primero revisar el ultimo para recien obtener el id y pasarlo.